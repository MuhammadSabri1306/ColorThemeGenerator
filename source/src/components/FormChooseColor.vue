		...
		<div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
			...
			<div class="flex flex-col justify-stretch">
				<div v-if="value.length > 0" class="flex mb-8 pl-16 pr-16 lg:pl-0 lg:flex-col lg:items-end">
					...
					<LabelColorCircle :color="value" :label="activeTabs.twPalette ? twColorSelected.name : value" :circleClassList="['w-16', 'h-16']" :labelClassList="['text-gray-500', 'font-semibold', 'text-sm']" />
				</div>
